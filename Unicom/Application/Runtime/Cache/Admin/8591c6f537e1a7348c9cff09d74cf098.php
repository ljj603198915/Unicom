...
<div class="container">
	<div class="col-md-12">
		...
		<form class="form-horizontal templatemo-container templatemo-login-form-1 margin-bottom-30" role="form" action="/index.php/Admin/AdminUser/login" method="post">
			...
			<div class="form-group">
				<div class="col-xs-12">
					<div class="control-wrapper">
						...
						<span id="code"><img src="/index.php/Admin/AdminUser/VerifyImg" onclick="this.src='/index.php/Admin/AdminUser/VerifyImg/' +Math.random()"></span>
